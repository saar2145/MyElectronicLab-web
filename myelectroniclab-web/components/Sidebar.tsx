...
export default function Sidebar({ categories }: { categories: CategoryGroup[] }) {
  ...
  return (
    <nav className="fixed top-[235px] right-4 z-40 hidden max-h-[calc(100vh-255px)] w-64 overflow-y-auto rounded-2xl bg-brand-cardbg shadow-md ring-1 ring-black/5 md:block">
